 ...
 */
	 ...
	 */
	 ...
	 /**
		...
		public String updateProduct_type(Invest_product invest_product,Model model) throws Exception{
			
			List<Invest_product> list =investProductService.getInvest_productsByPage(1, 5);
			...
			model.addAttribute("invest_product",list);
		 ...
		 */
		 ...
		 /**
		    ...
		    public String addProduct(Invest_product invest_product,HttpServletRequest request,HttpServletResponse response) throws Exception{ 
		    	...
		    	if (num > 0) {
		    		List<Msg_push> list = msgService.getMsgList(1, 5);
	...
	public String infoCenter(Model model,HttpSession session,@RequestParam(value="pageIndex",required=false) String pageIndex){
		...
		if(pageIndex != null){
			...
			try {
				msg =msgService.getMsgList(0,0,currentPageNo, pageSize);
			} catch (Exception e) {
				e.printStackTrace();
			}
			model.addAttribute("pages", pages);
	...
	public String updateMsg(Msg_push msg_push,Model model) throws Exception{
		List<Msg_push> list = msgService.getMsgList(0,0,1, 5);
