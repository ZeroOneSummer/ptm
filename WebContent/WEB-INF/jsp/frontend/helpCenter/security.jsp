    ...
    <div class="kdlc_pc_wrap">
        ...
        <div class="container">           
			<div id="help_wrap">
			    <div class="content">
			        <ul id="help_nav">
                        <li id="title_property"><a href="moneyInfo.jsp" class="title_a">资产说明</a></li>
                        <li id="title_function"><a href="moneyInfo.jsp" class="title_a">功能介绍</a></li>
                        <li id="title_goods"><a href="moneyInfo.jsp" class="title_a">产品介绍</a></li>
                        <li id="title_safety" class="help_curr_option"><a href="#" class="title_a">安全特性</a></li>
                    </ul>
			        <ul id="help_content">
                        <li>
