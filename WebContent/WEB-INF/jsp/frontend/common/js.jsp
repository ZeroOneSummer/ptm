...
<!-- 头部js -->
    ...
    <script src="${pageContext.request.contextPath}/statics/js/jquery.effects.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/statics/localjs/footer.js"></script>