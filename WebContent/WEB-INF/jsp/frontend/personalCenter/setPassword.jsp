...
<body style="background: #F7F7F7;">
    <div class="kdlc_pc_wrap">
				...
				<div class="content">
					...
					<div class="my_pocket_body">
						...
						<div id="detail_invest_confirm">
							...
							<div class="_title"><span class="f_18_20 _333 f_left">设置交易密码</span>
							...
							<div class="_content a_right">
								...
								<div class="f_14_16 _333 a_center">147****1657</div>
			                    <!-- //用于阻止 chrome表单自动填充的占位符 -->
			                    <input class="_hidden" type="text">
			                    <input class="_hidden" type="password">
			                    <!-- //用于阻止 chrome表单自动填充的占位符 -->
								<span class="f_14_16 _333">创建交易密码</span><input type="password" autocomplete="off" class="_input" id="password"><br>
								<span class="f_14_16 _333">确认交易密码</span><input type="password" autocomplete="off" class="_input" id="repassword"><br>
			                    <div id="notification" class="f_14_16 ff534f a_center">&nbsp;</div>
								<a href="javascript:setpwd();" class="_input _border btn_fd5353 a_center f_20_50 fff" id="red_btn">设置</a>
							</div>
						</div>
						<div class="clear"></div>
					</div>
        ...
        <!-- 主体部分结束 -->
		<script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/personalCenter_setPassword.js"></script>       
		<!-- 尾部开始 -->
