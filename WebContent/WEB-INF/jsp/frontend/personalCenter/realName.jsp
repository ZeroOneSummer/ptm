...
<body style="background: #F7F7F7;">
	<div class="kdlc_pc_wrap">
					...
					<div class="my_pocket_body">
						...
						<div class="my_pocket_content">
							...
							<div class="_content a_right">
								...
								<span class="f_14_16 _333">姓名</span><input type="text"
									id="username" class="_input"><br> <span
		...
		<!-- 主体部分结束 -->
		<script type="text/javascript"
			src="${pageContext.request.contextPath }/statics/localjs/personalCenter_realName.js"></script>
		<!-- 尾部开始 -->
