...
<body style="background: #F7F7F7;">
	<div class="kdlc_pc_wrap">
			        	...
			        	<script type="text/javascript">
			               ...
			               <div class="my_pocket_content">
							...
							<div class="_title clear">
								<h3 class="f_18_20 _333">
									绑定银行卡 <a href="account.jsp" class="f_14_16 ff534f f_right">&lt;&nbsp;返回</a>
								</h3>
							</div>
							<div class="_content a_right clear_inline_block">
								...
								<div>
									<label class="f_14_16 _333">银行卡卡号</label> <input type="text"
										class="_input" name="bank_card" id="bank_card">
								</div>
								...
								<a class="_input _border btn_fd5353 a_center f_20_50 fff"
									id="submit">确认</a>
							</div>
						</div>
						<div class="clear"></div>
		...
		<!-- 主体部分结束 -->
		<script type="text/javascript"
			src="${pageContext.request.contextPath }/statics/localjs/personalCenter_BindBack.js"></script>
		<!-- 尾部开始 -->
