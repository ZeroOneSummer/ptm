...
<body style="background: #F7F7F7;">
	<div class="kdlc_pc_wrap">
			...
			<div class="evt-mod">
					...
					<div class="pro-table">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<tbody id="pc_list_data">
								<c:forEach items="${product_list_page}" var="invest_product">
				...
				<div class="list-floor floor3 clearfix">
					<div class="f_left floor3-evt1 mb30">
						...
						<ul class="kdb-intro">
							<c:forEach items="${product_list_page}" var="invest_product" varStatus="status">
		...
		<!-- 主体部分结束 -->
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/statics/localjs/invest_2.js"></script>
		<!-- 底部开始 -->
