...
<body style="background: #F7F7F7;">
	<div class="kdlc_pc_wrap">
		...
		<!-- 头部结束 -->
		<c:if test="${type_list == null || info == null}">
			...
			<div id="index_wraper">
				<div id="sliderbanner">
					<div class="banner_image" id="banner"
						style="width: 100%; background: url(&quot;statics/img/05979969bdf6a3.png&quot;) center center no-repeat rgb(255, 227, 190); display: none;">
						<a class="indie" target="_blank" href="javascript:void(0);"></a>
					</div>
					<div class="banner_image _hidden" id="banner"
						style="width: 100%; background: url(&quot;statics/img/159c0f1bf9d7e4.jpg&quot;) center center no-repeat rgb(23, 42, 98); display: none;">
						<a class="indie" target="_blank" href="javascript:void(0);"></a>
					</div>
					<div class="banner_image _hidden" id="banner"
						style="width: 100%; background: url(&quot;statics/img/2598bf525c0242.png&quot;) center center no-repeat rgb(239, 239, 239); display: block; opacity: 0.943102;">
						<a class="indie" target="_blank" href="javascript:void(0);"></a>
					</div>
					<div class="banner_image _hidden" id="banner"
						style="width: 100%; background: url(&quot;statics/img/858a6768fc3ae0.jpg&quot;) center center no-repeat rgb(3, 0, 47); display: block; opacity: 0.968982;">
						<a class="indie" target="_blank" href="javascript:void(0);"></a>
					</div>
					<div class="banner_image _hidden" id="banner"
						style="width: 100%; background: url(&quot;statics/img/059af988548298.png&quot;) center center no-repeat rgb(110, 167, 230); display: none;">
						<a class="indie" target="_blank" href="javascript:void(0);"></a>
					</div>
				</div>
				<div id="banner_content">
					<div class="content">
						<div class="banner_column p_relative f_right _b_radius">
							<div class="banner_c1">
								<p>
									<i class="f_20">年化10%&nbsp;&nbsp;新手特权</i><br> <span
										class="lh_em_1_5 f_16 _999 letter_spacing__2">新注册用户更享好礼</span>
								</p>
							</div>
							<div class="banner_c2">
								<p>
									<i class="f_20">上市公司背景</i><br> <span
										class="lh_em_1_5 f_16 _999 letter_spacing__2">投资资金仅限同卡进出</span>
								</p>
							</div>
							<div
				...
				<div class="sliderbanner_tabs" style="width: 300px;">
					<div class="_tab" eq="0"></div>
					<div class="_tab" eq="1"></div>
					<div class="_tab" eq="2"></div>
					<div class="_tab _tab_here" eq="3"></div>
					<div class="_tab" eq="4"></div>
				</div>
				<div id="column1" class="content bg_fff a_center">
					...
					<div class="column1_c1">
						...
						<div class="f_left" style="background: url(${pageContext.request.contextPath}/statics/img/column3_c2_2.png) no-repeat center top;">
							...
							<p class="lh_em_1_5 f_24_26 one-d" ><fmt:formatNumber value="${info.tradeAmount}"/></p>
						...
						<div class="f_left" style="background: url(${pageContext.request.contextPath}/statics/img/column3_c2_1.png) no-repeat center top;">
							 ...
							 <p class="lh_em_1_5 f_24_26 two-d" ><fmt:formatNumber value="${info.totalIncome}"/></p>
						...
						<div class="f_left" style="background: url(${pageContext.request.contextPath}/statics/img/column3_c2_6.png) no-repeat center top;">
							...
							<p class="lh_em_1_5 f_24_26 three-d" ><fmt:formatNumber value="${info.userAmount}"/></p>
						...
						<div class="f_left" style="background: url(${pageContext.request.contextPath}/statics/img/column3_c2_7.png) no-repeat center top;">
							<i class="_666">截至${date}平台累计交易额(元)</i>
							<p class="lh_em_1_5 f_24_26 four-d" ><fmt:formatNumber value="${info.totalAmount}"/></p>
					...
					<div class="content">
							...
							<c:forEach items="${type_list}" var="Invest_type" varStatus="i">
								<c:if test="${i.index<4}">
									<div class="f_left bg_fff zfy_hover">
										<p class="_title f_24_26 _666">${Invest_type.invTypeName}</p>
										<p class="f_36_38 fd5353">${Invest_type.annualYield*100}%</p>
										<p class="lh_em_2 f_14 _666">平均历史年化收益率</p>
										<div class="f_16 _desc">
											<i class="f_left">${Invest_type.deadline}天</i> <i class="f_right">${Invest_type.purchaseMoney}元起投</i>
											<div class="clear"></div>
										</div>
						...
						<div class="column2_c2">
							<div class="pic-top">
								<div>
									<img
										src="${pageContext.request.contextPath}/statics/img/bxn.png"
							...
							<div class="txt-bottom">
								<div>
									...
									<p class="txt-title">
										报喜鸟集团<br> <span>（股票代码：002154）</span>
									</p>
									成立于2001年，公司总资产43.5亿元，于2007年8月在深交所上市，是温州地区第一家上市的鞋服企业。先后荣获中国驰名商标、中国名牌产品、最受消费者欢迎的男品牌等一系列荣誉称号，2004年首批荣获中国服装品质大奖。
								</div>
				...
				<div id="column3" class="bg_fff a_center">
					<div class="content">
						<div class="common_title">
							<div class="bg_fff">
								<h3>金融协会成员</h3>
								<p class="sub_title _999 f_14_16">member of finance
									association</p>
								<div class="sub_border"></div>
							</div>
							<div class="_border"></div>
						...
						<div class="column3_c1">
							<div class="p_relative f_left">
								<a class="hover_2" href="javascript:void(0);"> <img
									src="${pageContext.request.contextPath}/statics/img/column3_3.png">
								</a>
								<p class="lh_em_2 a_left f_18 _333">
									<a href="javascript:void(0);"> <span class=" _333 f_left">上海金融信息行业协会副会长单位</span>
									</a>
							...
							<div class="p_relative f_left">
								<a class="hover_2" href="javascript:void(0);"> <img
									src="${pageContext.request.contextPath}/statics/img/huan.jpg">
								</a>
								<p class="lh_em_2 a_left f_18 _333">
									<a href="javascript:void(0);"> <span class=" _333 f_left">上海市互联网金融行业协会理事单位</span>
									</a>
						...
						<div class="column3_c2">
							<table class="column3_c2_tb a_left">
								<tbody>
									<tr>
										<td class="v_top">
											<p class="lh_em_2 f_20 _333">
												<img class="v_center"
													src="${pageContext.request.contextPath}/statics/img/column3_c2_1.png"><i
													class="v_center">&nbsp;&nbsp;小额借贷&nbsp;&nbsp;分散风险</i>
											</p>
										...
										<td class="v_top">
											<p class="lh_em_2 f_20 _333">
												<img class="v_center"
													src="${pageContext.request.contextPath}/statics/img/column3_c2_2.png"><i
													class="v_center">&nbsp;&nbsp;江西银行存管</i>
											</p>
										...
										<td class="v_top">
											<p class="lh_em_2 f_20 _333">
												<img class="v_center"
													src="${pageContext.request.contextPath}/statics/img/column3_c2_3.png"><i
													class="v_center">&nbsp;&nbsp;债权合作方连带责任担保</i>
											</p>
									...
									<tr>
										<td class="v_top">
											<p class="lh_em_2 f_20 _333">
												<img class="v_center"
													src="${pageContext.request.contextPath}/statics/img/column3_c2_4.png"><i
													class="v_center">&nbsp;&nbsp;债权真实&nbsp;&nbsp;信息透明</i>
											</p>
										...
										<td class="v_top">
											<p class="lh_em_2 f_20 _333">
												<img class="v_center"
													src="${pageContext.request.contextPath}/statics/img/column3_c2_7.png"><i
													class="v_center">&nbsp;&nbsp;大数据智能风控系统</i>
											</p>
										...
										<td class="v_top">
											<p class="lh_em_2 f_20 _333">
												<img class="v_center"
													src="${pageContext.request.contextPath}/statics/img/column3_c2_6.png"><i
													class="v_center">&nbsp;&nbsp;专业法务团队支持</i>
											</p>
											<p class="lh_em_1_5 f_14 _666">聘请盈科（上海）
												律师事务所作为口袋理财的常年法律顾问，在口袋理财业务经营的合规性评估、业务合同的起草与审查、金融产品风险控制等多方面提供法律支持。</p>
										</td>
									</tr>
								</tbody>
							</table>
					...
					<div class="content">
						...
						<div class="column4_c1_right f_right">
								  <c:if test="${msgList != null}">
									...
									<c:if test="${msgList == null}"> 
						                	<p style="padding-top: 100px;color:rbga(0,0,0,0.4);">
												<h1>暂无公告数据</h1>
											</p>
					               </c:if> 
						</div>
