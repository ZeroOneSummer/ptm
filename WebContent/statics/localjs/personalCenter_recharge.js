var _hmt = _hmt || [];
        ...
        function selectBank(bank_code, third_platform)
        {
            ...
            $('.icon-bank-selected').removeClass("icon-bank-selected").addClass("icon-bank");
            ...
            if (data.code == 0){
                ...
                if (data.data.length > 0){
                    $.each(data.data,function(index,value){
                        ...
                        html +='<td class="a_center f_14_16 _333">' + (value.statusLabel ? value.statusLabel : '----') +'</td>';
                        html +='</tr>';
                    });
                    page++;
                }else{
       ...
       function bankLimit()
        {       
            ...
            var datalimit = {'bank_code' : $('#bank_code').val()};
