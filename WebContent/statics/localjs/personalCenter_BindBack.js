 var _hmt = _hmt || [];
        ...
        function withdraw(){
      	  ...
      	  var params = {};KD.util.post(url, params, function(data){
              if (data.code == 0){
    	...
    	function getCardBin() {
    		var bank_card = $("#notification").val();
    		$.post("/account/card-bin-query", {
    			bank_card : bank_card
    		}, function(data) {
    			if (data.code == 0){
    				bank_code = data.bank_code;
    				bank_name = data.bank_name;
    				$("#notification").text(bank_name);
    				return true;
    			} else {
