var _hmt = _hmt || [];
        ...
        $(document).ready(function(){
            ...
            getWithdrawLog();
                ...
                $("#shrinkage").click(function(){
                    var Default = "https://www.koudailc.com/image/site/more.jpg";
                    var Change = "https://www.koudailc.com/image/site/more1.jpg";
        ...
        function withdraw(){
            if (!$('#withdraw').hasClass("btn_eb4444") ){
                if ( checkForm() ){
                    EnableWithDraw();
                    //下单
                    var urlorder = "https://deposit.koudailc.com/account/withdraw-order?clientType=pc";
                    AjaxJsonP(callWithdrawOrder,urlorder);
                }
            }
            ...
            if (data.code == 0){
                ...
                if (data.data.length > 0){
                    $.each(data.data,function(index,value){
                        html +='<tr>';
                        html +='<td class="a_center f_14_16 _333">'+ UnixToDate(value.created_at,true,false) +'</td>';
                        html +='<td class="a_center f_14_16 _333">'+ safeConvertIntToCent(value.money) + '</td>';
                        html +='<td class="a_center f_14_16 _333">' + value.statusLabel +'</td>';
                        html +='</tr>';
                    });
                    page++;
                }else{
        ...
        function AccountGet(data){
            if (data.code == 0){
                ...
                $('#bank').html(data.banks[0].bank_name + '  &nbsp;*' + data.banks[0].tail_number);
            }
        }
