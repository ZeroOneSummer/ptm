  var _hmt = _hmt || [];
      ...
      function id_verify(){
          ...
          if( ck_username() && ck_idcard() ){
              var ajaxurl = "https://deposit.koudailc.com/user/real-verify?clientType=pc";
              var params =  {
              ...
              KD.util.post(ajaxurl, params, function(data){
                  if (data.code == 0 || data.message == "您已认证通过，无需重复认证"){
                      window.location.href = "https://www.koudailc.com/account/user-center-trader-pwd"+'?redirect_url='+redirect_url;
                  }else{
