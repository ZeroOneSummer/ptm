$(document).ready(function () {	
	...
	AWS.load_list_view(G_BASE_URL + '/people/ajax/user_type/uid-' + PEOPLE_USER_ID + '__actions-201', $('#bp_user_actions_answers_more'), $('#contents_user_actions_answers'));	// 参与的问题
	...
	AWS.load_list_view(G_BASE_URL + '/people/ajax/user_type/uid-' + PEOPLE_USER_ID + '__actions-101', $('#bp_user_actions_questions_more'), $('#contents_user_actions_questions'));	// 发起的问题
	...
	AWS.load_list_view(G_BASE_URL + '/account/ajax/integral_log/', $('#bp_user_integral'), $('#contents_user_integral'));	// 成长值
