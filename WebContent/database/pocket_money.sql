...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='投资产品信息表';

/*Data for the table `invest_product` */

insert  into `invest_product`(`id`,`produceName`,`invTypeId`,`investor`,`totalAmount`,`residueAmount`,`invStatus`) values (1,'新手宝-信17JQO1期',1,36,1000000.00,387000.00,2),(2,'月盈宝-信17JWQ4期',2,24,1000000.00,580000.00,2),(3,'新手宝-信17JQ01期',1,36,1000000.00,394000.00,2),(4,'月盈宝-信17JQ04期',2,24,1000000.00,0.00,3),(5,'季盈宝-信17JQ02期',3,28,1000000.00,600000.00,2),(6,'双季盈-信17JQ03期',4,35,1000000.00,480000.00,2),(7,'年盈宝-信17JWT7期',5,4,1000000.00,955000.00,2),(8,'月盈宝-信17EQ02期',2,22,1000000.00,0.00,3),(9,'双季盈-信17SJ03期',4,13,1000000.00,450000.00,2),(10,'年盈宝-信17JWT5期',5,18,1000000.00,940000.00,2),(11,'新手宝-信17JQO5期',1,40,1000000.00,463000.00,2),(12,'新手宝-信17JQO3期',1,52,1000000.00,531000.00,3),(13,'年盈宝WR05期',5,0,66666.00,66666.00,2);
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='消息推送表';

/*Data for the table `msg_push` */

insert  into `msg_push`(`id`,`msgType`,`content`,`releaseDate`,`title`,`userId`) values (6,1,'您在2017-10-29 14:52:15成功充值了50元！','2017-10-29 00:00:00','用户充值消息',2),(7,1,'您在2017-10-29 14:53:03成功充值了100元！','2017-10-29 00:00:00','用户充值消息',3),(8,1,'您在2017-10-29 19:37:12成功充值了120元！','2017-10-29 00:00:00','用户充值消息',2),(9,2,'您在2017-10-30 08:10:46成功提现了11.0元！','2017-10-30 00:00:00','用户提现消息',2),(10,2,'您在2017-10-30 08:26:24成功提现了1009.12元！','2017-10-30 00:00:00','用户提现消息',2),(11,2,'您在2017-10-30 08:30:12成功提现了1000.0元！','2017-10-30 00:00:00','用户提现消息',2),(12,1,'您在2017-11-01 22:20:22成功充值了11.0元！','2017-11-01 00:00:00','用户充值消息',2);
...
insert  into `user_property`(`id`,`pocketId`,`userId`,`balance`,`score`,`withdrawMoney`,`invProperty`) values (1,1,2,10011.00,86,10.12,10000.00),(2,1,3,11300.13,77,2000.00,5000.00);
