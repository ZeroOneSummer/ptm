...
CREATE TABLE `info_statis` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='信息累计表';

/*Data for the table `info_statis` */

insert  into `info_statis`(`id`,`monthStatis`,`tradeAmount`,`totalAmount`,`userAmount`,`totalIncome`) values (1,'2017-05-31 00:00:00',2813988358.00,24202563580.00,5236545,414018835.00),(2,'2017-06-30 00:00:00',3255655451.00,28102563580.00,6566560,514018835.00),(3,'2017-11-03 17:35:40',6666666.00,666666666.00,88888888,88888888888.00),(4,'2017-11-03 17:35:50',6666666.00,666666666.00,88888888,88888888888.00);
